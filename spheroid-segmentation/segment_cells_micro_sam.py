...
#OUTPUT_DIR    = Path(r"D:\ToxBox\Preprocessing_KIT\Data_segmented")
#EMBEDDING_DIR = Path(r"D:\ToxBox\Preprocessing_KIT\Data_embeddings")

INPUT_DIR     = Path(r"D:\ToxBox\Preprocessing_KIT\Data_Co-exposure HEPG-only spheroids")
OUTPUT_DIR    = Path(r"D:\ToxBox\Preprocessing_KIT\Data_segmented_Co-exposure HEPG-only spheroids")
EMBEDDING_DIR = Path(r"D:\ToxBox\Preprocessing_KIT\Data_embeddings_Co-exposure HEPG-only spheroids")
